...
public class Graph {
	...
	final int n; // numero de nos 
	final int m; // numero de arcos
	final protected ArrayList<Integer>[] succ; //lista de sucessores
	final protected ArrayList<Integer>[] pred; //lista de predecessores
